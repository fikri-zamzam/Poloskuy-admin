        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 style="text-align: center; font-size: 230%;" class="card-title">List Transaksi</h4>
                  <div class="table-responsive pt-3">
                    <table class="table table-dark">
                      ...
                      <?php 
                        $no = 1;
                        $lht_Produk = $db->getData("transaksi","*","id_status != 1 ");
                        ...
                        <tr style="text-align: center">
                          ...
                          <td>
                            <?= $res["tanggal_transaksi"] ?>
                          </td>
                          <td >
                            <?= $db->FindID("jenis_status",$res["id_status"]) ?>
                          </td>
                          <td >
                            <?= $db->rupiah($res["total_harga"]) ?>
                          </td>
                          <td >
                            <div>
                              <a class="btn btn-info auth-form-btn btn-icon-append btn-sm" href="edit_statusTransaksi.php?id=<?=$res["id_transaksi"]?>">
                                <i class="mdi mdi-note"></i> Lihat detail
                              </a><br>
                            </div>
                          </td>
