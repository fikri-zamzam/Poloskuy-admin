            ...
            <div class="navbar-menu-wrapper navbar-search-wrapper d-none d-lg-flex align-items-center">
              ...
              <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item nav-profile dropdown">
                  ...
                  <div href="../../navigasi/logout.php" class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-dark table-hover table-striped">
                      ...
                      <tbody>
                        <?php
                          ...
                          $no = $posisi+1;
                          $lht_Admin = $db->getData("admin order by id_admin desc limit $posisi,$batas","*");
                  ...
                  <?php 
                  $query2 = $db->execute("SELECT * FROM admin");
                    ...
                    <div class="text-center">
                      ...
                      <?php
                        for($i=1;$i<=$jmlhalaman;$i++) {
                            if ($i != $halaman) {
                                echo "<li class='page-item'><a class='page-link' href='list_admin.php?halaman=$i'>$i</a></li>";
                            } else {
                  ...
                  <br><a href="../../system/cetak-pdf.php?id=cetakAdmin.php&jd=Data Admin">
