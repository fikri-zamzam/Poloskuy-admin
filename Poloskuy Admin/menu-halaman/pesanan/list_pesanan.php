                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered table-hover table-striped">
                      ...
                      <?php 
                        $no = 1;
                        $lht_Produk = $db->getData("transaksi","*","id_status = 'ST0SLFCV' ");
                        ...
                        <tr style="text-align: center;">
                          ...
                          <td >
                            <div>
                              <a class="btn btn-success auth-form-btn btn-icon-append btn-sm" href="edit_pesanan.php?id=<?=$res["id_transaksi"]?>">
