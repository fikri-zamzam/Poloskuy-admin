...
if(isset($_POST["edit"])){
  ...
  $edit = $db->update('user',['id_user'=>$id,'email'=>$email,'password'=>$password,'user_fullname'=>$fullname,'no_telp'=>$telfon,'gender'=>$gender,'alamat'=>$alamat],"id_user='$id'");
  ...
  $upload = (($imgNama == "") ? "aman" : $img->upFoto('user',$imgNama,$size,$asal,$format,"id_user='$id'") );
    ...
    ?>
    <script>
      alert("Selamat data user <?=$fullname?> berhasil di ubah");
    ...
    ?>
    <script>
      alert("Maaf data user <?=$fullname?> gagal di ubah");
      // location.href = "list_user.php";
    </script>
    <?php
  }
