...
if(isset($_POST["tambah"])){
  ...
  $id = $db->buatID("id_kategori");
  $kategori = $db->penjernih($_POST["nama_kat"]);

  $tambah = $db->insert('kategori',['id_kategori'=>$id,'nama_kategori'=>$kategori]);
  
  if($tambah){
    ?>
    <script>
      alert("Selamat Kategori <?=$kategori?> berhasil di Tambah");
    ...
    <?php
      ...
      ?>
      <script>
        alert("Maaf Kategori <?=$kategori?> Gagal di Tambah");
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title" style="text-align: center; font-size: 230%; ">KATEGORI</h4>
                  ...
                  <form class="forms-sample" action="#" method="POST" >
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          <button class="btn btn-dark font-weight-medium auth-form-btn" type="submit" name="tambah">Tambah Kategori</button>
                          <a class="btn btn-light font-weight-medium auth-form-btn" type="reset" >Batal</a>
                      </div>
                      </div>
                  </form>
                  ...
                  <div class="table-responsive pt-4">
                    <table class="table table-striped table-dark" >
                      ...
                      <tbody class="table table-sm table-dark">
                        <?php 
                        $no = 1;
                        $lht_Produk = $db->getData("kategori");
                        ...
                        <tr>
                          <th scope="row" style="text-align: center;"><?= $no ?></th>
                            <td style="text-align: center;"><?= $res["id_kategori"] ?></td>
                            <td style="text-align: center;"><?= $res["nama_kategori"] ?></td>
                            <td style="text-align:center;">
                              <a class="btn btn-dark font-weight-medium auth-form-btn btn-icon-append btn-sm" href="z_edit_kategori.php?id=<?=$res["id_kategori"] ?>" >
                                <i class="mdi mdi-pencil"></i>
                            </a>
                              <br><a class="btn btn-danger font-weight-medium auth-form-btn btn-icon-append btn-sm" href="z_del_kategori.php?id=<?=$res["id_kategori"] ?>">
