            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-dark table-hover table-striped" >
                      ...
                      <tbody >
                        ...
                        $no = $posisi+1;
                        $lht_Produk = $db->getData("produk order by id_produk desc limit $posisi,$batas","*");
                  ...
                  <?php 
                    $query2 = $db->execute("SELECT * FROM produk");
                    ...
                    <div class="text-center">
                      ...
                      <?php
                        for($i=1;$i<=$jmlhalaman;$i++) {
                            if ($i != $halaman) {
                                echo "<li class='page-item'><a class='page-link' href='list_barang.php?halaman=$i'>$i</a></li>";
                            } else {
                  ...
                  <br> <a href="../../system/cetak-pdf.php?id=cetakProduk.php&jd=Data Barang">
