...
if(isset($_POST["edit"])){
  ...
  $kategori = $db->penjernih($_POST["nama_kategori"]);

  $edit = $db->update('kategori',['nama_kategori'=>$kategori],"id_kategori = '$id' ");


  if ($edit){
    ?>
      <script>
        alert("Selamat <?=$kategori?> berhasil diubah");
    ...
    ?>
    <script>
      alert("Maaf <?=$kategori?> Gagal diubah");
    </script>
    <?php
  }
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title" style="text-align: center; font-size: 230%; ">TAMBAH KATEGORI</h4>
                  <form class="forms-sample" action="#" method="POST" enctype="multipart/form-data"><br>
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">ID Kategori</label>
                            <div class="col-sm-7">
                              <input type="text" class="form-control" placeholder="ID Kategori" name="id_kategori" value="<?=$id?>" readonly/>
                            </div>
                          </div>
                          <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nama Kategori</label>
                            <div class="col-sm-7">
                              <input type="text" class="form-control" placeholder="Jenis Kategori" name="nama_kategori" value="<?= $db->FindID("nama_kategori",$id) ?>" />
                            </div>
                          </div>
                      <div class="row">
                        <div class="mt-3">
                          <button class="btn btn-info btn-fw btn-rounded font-weight-medium auth-form-btn" type="submit" name="edit">Daftarkan User</button>
                          <a class="btn btn-danger btn-rounded font-weight-medium auth-form-btn" href="z_list_kategori.php">Batal</a>
                        </div>
                      </div>
                  </form>
                </div>
