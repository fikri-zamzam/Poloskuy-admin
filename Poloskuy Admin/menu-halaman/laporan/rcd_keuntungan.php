...
if (!isset($_SESSION['id_admin'])) {
  ...
  $ambil = $db->getData("transaksi","SUM(total_harga) as laba, COUNT(id_transaksi) as jmlTrans","");
  foreach ($ambil as $key => $edt) {
    $laba = $edt["laba"];
    $jmlTrans = $edt["jmlTrans"];
  }

  $ambil = $db->getData("detail_transaksi"," COUNT(kuantitas) as jmlDetTrans,max(kuantitas) as maxPesan","");
  foreach ($ambil as $key => $edt) {
    $detil = $edt["jmlDetTrans"];
    $maxPesan = $edt["maxPesan"];
  }
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 style="text-align: center; font-size: 180%;" class="card-title">Record Keuntungan Penjualan</h4>
                    ...
                    <table class="table table-keuntungan table-bordered">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            Jumlah barang per pesanan terbanyak
                          </td>
                          <td>
                            <?=$maxPesan?>
                          </td>
