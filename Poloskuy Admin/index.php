...
<head>
  ...
  <title>Poloskuy Admin Page</title>
  <!-- base:css -->
      ...
      <ul class="nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="menu-halaman/barang/add_barang.php">Tambah</a></li>
              <li class="nav-item"> <a class="nav-link" href="menu-halaman/barang/list_barang.php">Lihat</a></li>
              <li class="nav-item"> <a class="nav-link" href="menu-halaman/barang/z_list_kategori.php">Kategori</a></li>
            </ul>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic2">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="menu-halaman/user/add_user.php">Tambah</a></li>
              <li class="nav-item"> <a class="nav-link" href="menu-halaman/user/list_user.php">Lihat</a></li>
            </ul>
          </div>
        </li>
        ...
        <?php if($sysLevel == 1) { ?>
        <li class="nav-item">
          <a class="nav-link" href="menu-halaman/admin/list_admin.php">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic3">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="menu-halaman/laporan/rcd_keuntungan.php">Record Keuntungan</a></li>
              <li class="nav-item"> <a class="nav-link" href="menu-halaman/laporan/rcd_penjualan.php">Record Penjualan</a></li>
            </ul>
          </div>
        </li>
          <?php } ?>
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic4">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="menu-halaman/pesanan/list_pesanan.php">Pesanan</a></li>
              <li class="nav-item"> <a class="nav-link" href="menu-halaman/transaksi/list_transaksi.php">Transaksi</a></li>
            </ul>
          </div>
        </li>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <a href="menu-halaman/barang/list_barang.php">
                ...
                <div class="card-body py-5">
                  <div
                    ...
                    <div class="ml-3 ml-md-0 ml-xl-3">
                      <h5 class="text-white font-weight-bold"><?=$db->BanyakData("produk")?> Product</h5>
                      <p class="mt-2 text-white card-text">Cek di menu Barang</p>
                    </div>
                  </div>
                </div></a>
              </div>
            ...
            <div class="col-md-4 grid-margin stretch-card">
            <a href="menu-halaman/pesanan/list_pesanan.php">
              <div class="card bg-google d-flex align-items-center">
                <div class="card-body py-5">
                  <div
                    ...
                    <div class="ml-3 ml-md-0 ml-xl-3">
                      <h5 class="text-white font-weight-bold"><?=$db->BanyakData("transaksi WHERE id_status = 'ST0SLFCV'")?> New Order</h5>
                      <p class="mt-2 text-white card-text">cek di menu pesanan</p>
                    </div>
                  </div>
                </div></a>
              </div>
            ...
            <div class="col-md-4 grid-margin stretch-card">
            <a href="menu-halaman/user/list_user.php">
              <div class="card bg-twitter d-flex align-items-center">
                <div class="card-body py-5">
                  <div
                    ...
                    <div class="ml-3 ml-md-0 ml-xl-3">
                      <h5 class="text-white font-weight-bold"><?=$db->BanyakData("user")?> User</h5>
                      <p class="mt-2 text-white card-text">cek di menu user</p>
                    </div>
                  </div>
                </div></a>
              </div>
