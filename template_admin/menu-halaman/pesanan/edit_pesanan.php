                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample">
                      ...
                      <div class="mt-3">
                        <a class="btn btn-dark font-weight-medium auth-form-btn" href="../pesanan/list_pesanan.php">SIMPAN</a>
                        <a class="btn btn-light font-weight-medium auth-form-btn" href="../pesanan/list_pesanan.php">Batal</a>
                      </div>
                    </form>
                  </div>
                </div>
