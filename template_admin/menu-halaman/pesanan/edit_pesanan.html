        ...
        <div class="content-wrapper">
          <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 style="text-align: center; font-size: 230%;" class="card-title">EDIT PESANAN</h4><br>
                    <form class="form-sample">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">No Pesanan</label>
                            <div class="col-sm-9">
                      ...
                      <div class="mt-3">
                        <a class="btn btn-dark font-weight-medium auth-form-btn" href="../pesanan/list_pesanan.html">SIMPAN</a>
                        <a class="btn btn-light font-weight-medium auth-form-btn" href="../pesanan/list_pesanan.html">Batal</a>
                      </div>
                    </form>
                  </div>
                </div>
