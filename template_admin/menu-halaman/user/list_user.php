                    ...
                    <table class="table table-dark table-hover table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align:center;">
                            <div class="mt-3">
                              <a class="btn btn-dark font-weight-medium auth-form-btn btn-icon-append btn-sm" href="../user/edit_user.html">
                                <i class="mdi mdi-pencil"></i>
                              </a><br>
                              <br><a class="btn btn-danger font-weight-medium auth-form-btn btn-icon-append btn-sm" href="../user/z_list_blacklist.html">
