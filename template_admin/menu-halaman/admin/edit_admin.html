              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="mt-3">
                      <a class="btn btn-dark font-weight-medium auth-form-btn" href="../admin/list_admin.html">SIMPAN</a>
                      <a class="btn btn-light font-weight-medium auth-form-btn" href="../admin/list_admin.html">Batal</a>
                    </div>
                  </form>
                </div>
              </div>
