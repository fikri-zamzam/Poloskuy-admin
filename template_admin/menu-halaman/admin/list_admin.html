              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="mt-3" style="padding: 0px 890px;">
                    <a class="btn btn-info btn-md font-weight-medium auth-form-btn" href="../admin/add_admin.html">REGISTER</a>
                  </div>
                    ...
                    <table class="table table-dark table-hover table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align: center;">
                            <div class="mt">
                              <a class="btn btn-dark font-weight-medium auth-form-btn btn-icon-append btn-sm" href="../admin/edit_admin.html">
                                <i class="mdi mdi-pencil"></i>
                            </a><br>
                              <br><a class="btn btn-danger font-weight-medium auth-form-btn btn-icon-append btn-sm" href="../admin/list_admin.html">
